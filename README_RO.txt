...
Aplicația suportă adăugarea în request-urile HTTP a cookie-urilor, a unui token JWT, 
ține cont de nişte valori default în cazul în care unii parametrii lipsesc (programare 
defensivă) etc. La acestea se adaugă utilizarea numeroaselor funcţii-helper, dedicate 
parsării unui răspuns de la server în sensul obţinerii anumitor parametrii, precum 
cookie-uri, parametrii URL etc.
